...
void add_cube(std::array<double,6>& cubeInfo, std::string name){
    ...
    g_planning_scene->getWorldNonConst()->addToObject(name, cube, pose);
...
// TODO: Remove Temp
    ...
    moveit::core::RobotState state = g_planning_scene->getCurrentStateNonConst();
